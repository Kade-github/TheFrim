#ifndef _RUINEDCOBBLESTONEBLOCK_H
#define _RUINEDCOBBLESTONEBLOCK_H

#include "../Block.h"

class RuinedCobblestone : public Block
{
public:
	RuinedCobblestone(glm::vec3 _position) : Block(_position, BlockType::RUINED_COBBLESTONE) {
		position = _position;
	...
	{
		glm::vec4 side = t->spriteSheet.GetUVFlip("ruined_cobblestone");
	...
	{
		glm::vec4 dirt = t->spriteSheet.GetUVFlip("ruined_cobblestone");
