...
{
public:
	Bedrock(glm::vec3 _position) : Block(_position, BlockType::BEDROCK) {
		position = _position;
	...
	{
		glm::vec4 side = t->spriteSheet.GetUVFlip("bedrock");
	...
	{
		glm::vec4 dirt = t->spriteSheet.GetUVFlip("bedrock");
