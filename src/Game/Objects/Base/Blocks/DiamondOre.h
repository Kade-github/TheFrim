#ifndef _DIAMONDOREBLOCK_H
#define _DIAMONDOREBLOCK_H
...
{
public:
	DiamondOre(glm::vec3 _position) : Block(_position, BlockType::DIAMOND_ORE) {
		position = _position;
	...
	{
		glm::vec4 side = t->spriteSheet.GetUVFlip("diamond_ore");
	...
	{
		glm::vec4 dirt = t->spriteSheet.GetUVFlip("diamond_ore");
