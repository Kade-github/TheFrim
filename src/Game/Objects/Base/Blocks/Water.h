...
public:
	...
	BlockFace CreateFrontFace() override
	{
		...
		return BlockFace(frontVertices, indices);
	}
	...
	BlockFace CreateLeftFace() override
	{
		...
		return BlockFace(leftVertices, indices);
	}
	...
	BlockFace CreateTopFace() override
	{
		...
		return BlockFace(topVertices, indices);
	}
	...
	BlockFace CreateBottomFace() override
	{
		...
		return BlockFace(bottomVertices, indices);
	}
	...
	void PlaceWater(Chunk* c, glm::vec3 _pos, int _strength);
