#ifndef _RUINEDDEBRIS_H
#define _RUINEDDEBRIS_H

#include "../Block.h"

class RuinedDebris : public Block
{
public:
	RuinedDebris(glm::vec3 _position) : Block(_position, BlockType::RUINED_DEBRIS) {
		position = _position;
	...
	{
		glm::vec4 side = t->spriteSheet.GetUVFlip("ruined_debris");
	...
	{
		glm::vec4 dirt = t->spriteSheet.GetUVFlip("ruined_debris");
