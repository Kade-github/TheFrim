#ifndef _GOLDOREBLOCK_H
#define _GOLDOREBLOCK_H
...
{
public:
	GoldOre(glm::vec3 _position) : Block(_position, BlockType::GOLD_ORE) {
		position = _position;
	...
	{
		glm::vec4 side = t->spriteSheet.GetUVFlip("gold_ore");
	...
	{
		glm::vec4 dirt = t->spriteSheet.GetUVFlip("gold_ore");
